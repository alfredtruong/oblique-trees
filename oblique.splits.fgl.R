#train trees
a <- oblique.tree(type~.,fgl,oblique.splits="off")							#fine
aa <- oblique.tree(type~.,fgl,oblique.splits="on")							#fine
aaa <- oblique.tree(type~.,fgl,oblique.splits="only")							#fine
...
##############################################################################################oblique splits off
	...
	plot(a);text(b,cex=CEX,srt=90);title(main="Axis-parallel splits only",cex=CEX);
x11();
...
##############################################################################################oblique splits on
	...
	plot(aa);text(bb,cex=CEX,srt=90);title(main="Both axis-parallel and oblique splits",cex=CEX);
x11();
...
##############################################################################################oblique splits only
	...
	plot(aaa);text(bbb,cex=CEX,srt=90);title(main="Oblique splits only",cex=CEX);
x11();
